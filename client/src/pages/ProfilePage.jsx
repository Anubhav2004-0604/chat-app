...
const ProfilePage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-2xl text-gray-300 border-2 boder-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        ...
        <img className={`max-w-44  aspect-square rounded-full mx-sm:mt-10 mr-5 ${selectedImg && 'rounded-full'}`} src={authUser?.profilePic || assets.logo_icon} alt="" />
      </div>
    </div>
  )
}
